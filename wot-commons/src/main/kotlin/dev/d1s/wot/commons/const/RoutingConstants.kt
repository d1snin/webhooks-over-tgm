...
private const val ID_MAPPING = "/{id}"
...
public const val GET_DELIVERY_MAPPING: String = DELIVERIES_BASE_MAPPING + ID_MAPPING
public const val GET_DELIVERIES_MAPPING: String = DELIVERIES_BASE_MAPPING
public const val DELETE_DELIVERY_MAPPING: String = DELIVERIES_BASE_MAPPING + ID_MAPPING

private const val TARGETS_BASE_MAPPING = "/targets"
public const val POST_TARGET_MAPPING: String = TARGETS_BASE_MAPPING
public const val GET_TARGET_MAPPING: String = TARGETS_BASE_MAPPING + ID_MAPPING
public const val GET_TARGETS_MAPPING: String = TARGETS_BASE_MAPPING
public const val PUT_TARGET_MAPPING: String = TARGETS_BASE_MAPPING + ID_MAPPING
public const val DELETE_TARGET_MAPPING: String = TARGETS_BASE_MAPPING + ID_MAPPING

private const val WEBHOOKS_BASE_MAPPING = "/webhooks"
public const val POST_WEBHOOK_MAPPING: String = WEBHOOKS_BASE_MAPPING
public const val GET_WEBHOOK_MAPPING: String = WEBHOOKS_BASE_MAPPING + ID_MAPPING
...
public const val PUT_WEBHOOK_MAPPING: String = WEBHOOKS_BASE_MAPPING + ID_MAPPING
public const val PATCH_WEBHOOK_NONCE_MAPPING: String = "$WEBHOOKS_BASE_MAPPING$ID_MAPPING/nonce"
public const val DELETE_WEBHOOK_MAPPING: String = WEBHOOKS_BASE_MAPPING + ID_MAPPING